    ...
    battleCalculator(pokemon1, pokemon2) {      
           ...
           .then(answers=>{  
               if (answers == 'burning feast') {
                   ...
                   if (pokemon1.isEffectiveAgainst(pokemon2)) {            
                     ...
                     .then(()=>{
                        return this.battleCalculator(pokemon2,pokemon1)
       ...
       if (pokemon1.type == 'normal') {
           ...
           .then(answers=>{ 
                   ...
                   if (pokemon1.isEffectiveAgainst(pokemon2)) {
                      return pokemon2.takeDamage(pokemon1.attackDamage *1.25).then(()=>{
                        return this.battleCalculator(pokemon2,pokemon1)
                     })
                   }
                   else if (pokemon1.isWeakTo(pokemon2)) {
                       return pokemon2.takeDamage(pokemon1.attackDamage * 0.75).then(()=>{
                        return this.battleCalculator(pokemon2,pokemon1)
                     })
                   }
   
                   else {
                        return pokemon2.takeDamage(pokemon1.attackDamage).then(()=>{
                            return this.battleCalculator(pokemon2,pokemon1)
                         })
                   }
